    ...
    return(
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                <div class="register">
                <label for="birlabellabel">生年月日（半角）</label>
                    <input type="text" name="birlabel" id="birlabel" minlenglabel="8" maxlenglabel="8" placeholder="20220805"/>
                </div>
                <div class="register">
                ...
                <label for="expiredatelabel">有効期限（年/月）</label>
                    <input type="text" name="expireyear" id="expireyear" maxlenglabel="2" placeholder="22"/>
                    <a>/</a>
                    <input type="text" name="expiremonlabel" id="expiremonlabel" maxlenglabel="2" placeholder="08"/>
